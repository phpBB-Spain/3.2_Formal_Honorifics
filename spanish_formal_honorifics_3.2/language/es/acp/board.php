...
$lang = array_merge($lang, array(
	...
	'COOKIE_PATH_EXPLAIN'		=> 'Tenga en cuenta que siempre se trata de una barra, no importa cuál sea la dirección URL de su foro.',
...
$lang = array_merge($lang, array(
 	...
 	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Está página permite a los usuarios enviar emails a los Administradores del foro',
...
$lang = array_merge($lang, array(
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Permitir conexiones al servidor SMTP con certificado SSL auto-firmado. <em><strong>Advertencia:</strong> Permitir los certificados SSL auto-firmados puede causar implicaciones de seguridad.</em>',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Requiere verificación del certificado SSL utilizado por el servidor SMTP. <em><strong>Advertencia:</strong> La conexión de pares con certificados SSL no verificados puede causar implicaciones de seguridad.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Verificar el nombre de usuario SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Requiere verificación del nombre de usuario para servidores SMTP que utilizan conexiones SSL / TLS. <em><strong>Advertencia:</strong> La conexión a pares no verificados puede causar implicaciones de seguridad.</em>',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Permitir conexiones al servidor Jabber con certificado SSL auto-firmado. <em><strong>Advertencia:</strong> Permitir los certificados SSL auto-firmados puede causar implicaciones de seguridad.</em>',
	'JAB_ENABLE'					=> 'Habilitar Jabber',
	'JAB_ENABLE_EXPLAIN'			=> 'Habilite el uso de mensajeria y notificaciones Jabber',
	'JAB_GTALK_NOTE'				=> 'Por favor fíjese en que GTalk no funcionará porque no se encontró la función <samp>dns_get_record</samp>. Esta función no está disponible en PHP4, y no está implementada en plataformas Windows. Actualmente no funciona en sistemas basados en BSD, incluído macOS.',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Requiere verificación del certificado SSL utilizado por el servidor Jabber. <em><strong>Advertencia:</strong> La conexión de pares con certificados SSL no verificados puede causar implicaciones de seguridad.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Verificar el nombre de los pares de Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Requiere verificación del nombre de los pares para los servidores Jabber mediante conexiones SSL / TLS. <em><strong>Advertencia:</strong> La conexión a pares no verificados puede causar implicaciones de seguridad.</em>',
));
