...
$lang = array_merge($lang, array(
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Si su cuenta existe, se envió una nueva contraseña a su dirección de correo electrónico registrada. Si no recibe un correo electrónico, puede ser porque está excluido (baneado), su cuenta no está activada, o no tiene permitido cambiar su contraseña. Póngase en contacto con el Administrador si cualquiera de esas razones se aplican. Además, compruebe su filtro de spam (bandeja de Correo no deseado).',
